...
$scriptBlock = {
    ...
    # Use Start-Process to launch each test in a new, separate cmd window
    # The tests now run for 10 seconds (-d10)
    Start-Process cmd -ArgumentList "/c diskspd.exe -c40G -b1M -d10 -r -w100 -t8 -o64 -L -Sh -L -Zr -W0 $smallTestFile"
    Start-Process cmd -ArgumentList "/c diskspd.exe -c40G -b8k -d10 -r -w10 -t16 -o256 -L -Sh -L -Zr -W0 $largeTestFile"
}
